...
//     ctx.moveTo(250, 0);
//     ctx.lineTo(250, 400);
//     ctx.moveTo((150+100/2), 0);
//     ctx.lineTo((150+100/2), 150);

//     ctx.moveTo((150+100/2), 250);
//     ctx.lineTo((150+100/2), 400);
...
//     ctx.moveTo(0, (150+100/2));
//     ctx.lineTo(150, (150+100/2));

//     ctx.moveTo(250, (150+100/2));
//     ctx.lineTo(400, (150+100/2));

//     ctx.stroke();
//     ctx.closePath()

//     ctx.clearRect(149, 149, 102, 102)
// }

// function loadImage(source, width = 21, height = 59) {
...
//     const arrowUp = await loadImage('./arrow-up.svg')
//     const arrowDown = await loadImage('./arrow-down.svg')
//     const arrowLeft = await loadImage('./arrow-left.svg')
//     const arrowRight = await loadImage('./arrow-right.svg')

//     ctx.drawImage(arrowUp, 164.71, 41.03, 21, 59)
//     ctx.drawImage(arrowUp, 164.71, 300, 21, 59)

//     ctx.drawImage(arrowDown, 214.71, 44, 21, 59)
//     ctx.drawImage(arrowDown, 214.71, 300, 21, 59)

//     ctx.drawImage(arrowLeft, 44, 214.5, 59, 21)
//     ctx.drawImage(arrowLeft, 300, 214.5, 59, 21)

//     ctx.drawImage(arrowRight, 44, 164.5, 59, 21)
//     ctx.drawImage(arrowRight, 300, 164.5, 59, 21)
// }
...
// function drawLamp(state) {
//     let vertical = ['red', 'yellow', 'green'][state]
//     let horizontal = ['green', 'yellow', 'red'][state]

//     drawCircle(225, 137, 5, vertical)
//     drawCircle(258, 223, 5, horizontal)
//     drawCircle(172, 258, 5, vertical)
//     drawCircle(137, 173, 5, horizontal)
// }

// function drawSecond(ms) {
//     ctx.clearRect(293, 10, 100, 30)
//     ctx.fillStyle = 'red'
//     ctx.font = '24px sans-serif'
//     ctx.textAlign = 'center'
//     ctx.fillText(Math.round(ms/1000), 314, 35, 70)
// }

// function changeLamp(ms) {
//     return new Promise((res) => {
//         setTimeout(() => {
//             if(state === 0 || state === 2) lastPos = state
//             state += (1*(lastPos === 2 ? -1 : 1));
//             drawLamp(state)
//             res(true)
//         }, ms + 1000)
//     })
...
//     ctx.fillStyle = '#666'
//     ctx.textAlign = 'center'
//     ctx.fillText('Detik', 293+70/2, 67, 70)

//     while(loop) {

//         // counter drawer
//         let ms = state === 1 ? 1000 : time
//         let countdown = ms

//         let interval = setInterval(() => {
//             drawSecond(countdown)
